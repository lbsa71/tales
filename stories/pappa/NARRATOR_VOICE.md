...
- Rak, varm och återhållen.
- Konkret före tolkande.
- Pappa är en människa, inte ett vårdfall.
- Vårdapparaten skildras utan vare sig hjältegloria eller automatisk misstänksamhet.
- Det medicinska språket får finnas kvar när dess precision behövs, men översätts direkt till vad det betydde för kroppen och dygnet.
...
- Uppfunna repliker.
- Pappans outtalade tankar eller känslor.
- Exakta sinnesintryck som sonen ännu inte har bekräftat.
...
- I brödtexten: främst `pappa`.
- `Lars` används när journalens blick eller vårdens tilltal behöver höras.
- `jag` används bara för sonen.
- Vårdpersonal namnges normalt inte; deras funktion är viktigare än deras namn.

## Rytm

Korta meningar får markera besked, förflyttningar och förändrade planer. Längre meningar används för väntan, sammanhang och de många samtidiga medicinska problemen.

Journalord kan återkomma som motiv: `stabil`, `målvärde`, `avvakta`, `förvirrad`, `sonen närvarande`. Berättelsen bör visa hur olika de orden kan kännas beroende på vem som läser dem.
