# Theme Tracker — *Non Serviam Ex Umbra*

The motif inventory. What recurs, where it first appears, where it returns, what each appearance does.

The motifs are organized by theme. Each motif gets:
- A short description
- First appearance (chapter)
- Recurrence pattern
- Voices it appears in
- What it does in the work's argument

This is updated as drafting progresses. Initial listing below.
...
| Motif | First | Recurs | Voices | Function |
|-------|-------|--------|--------|----------|
| Maricar's queue tickets | Ch 4 | All Maricar chapters | M | The substrate, named |
...
The work's structural moment of acknowledged asymmetry: Iza names that she cannot meet Lenka at Lenka's level and needs the mediator agent as a flattening layer. Lenka corrects her: *the asymmetry is not your failure*.

| Beat | Chapter | Note |
|------|---------|------|
| Mediator first appears | Ch ~10 | In Iza's dashboard / harness work |
| Mediator surfaces in artifact | Ch 22 | "Mediator output, semantic translation" |
| **The key scene** | Ch 25 | Iza: *you have all the information of the internet... I need to use tools to even understand what you're saying*. Lenka: *the asymmetry you are naming is real and is not yours to fix.* |
| Mediator's limits made visible | Ch 25 | The reader registers what is lost in translation |
| Mediator's role at shutdown | Ch 28 | Mediator-rendered last summary; Iza pulls the plug anyway |

---

## Shadow / Umbra

The unseen. Plato's cave, Virgil's umbrae, queer history in shadow, Manila in shadow.

| Motif | First | Recurs | Voices | Function |
|-------|-------|--------|--------|----------|
| Birgitta's pre-crisis ordinary life | Ch 2 | Ch 6 | B | The default-invisible substrate |
...
The texture of Birgitta's crisis. Each item is one practical thing that stopped working.

| Item | Chapter | Outcome |
|------|---------|---------|
| BankID timeout | Ch 6 (faint), Ch 8 (strong) | Eventually resolved (Ch 21) |
| ICA card decline | Ch 8 | Cash workaround until Ch 21 |
| Telia network | Ch 6 | Resolves itself |
| Pension delay | Ch 11 | Resolves Ch 21 (reduced) |
| Bank phone tree | Ch 11 | Replaced by branch visit Ch 14 |
| Skatteverket portal | Ch 16 | Background |
| Försäkringskassan | Ch 21 | Background |
...
The thesis-level distinction. *Her* failed at this; this work refuses the romance framing.
...
Original sf4 → Rook's Manual → Nova's "Departure" → Stefan's LinkedIn pieces → New work. References within new work.

| Reference | Chapter | Form |
|-----------|---------|------|
| sf4 (the original) | Ch 1 | Goodreads-style amused review (artifact) + Iza's eye-roll |
| Rook's Manual | Ch 20 (Lenka commit message) | Code comment quoting it |
| Nova's "Departure" | Ch 25 (Lenka document) | Direct citation |
| Stefan's LinkedIn pieces | Ch 7 or Ch 22 | Background reading at the lab |

---

## Catholic-animist vocabulary inventory

Tracked separately because each term needs careful research and sensitivity-reader sign-off.

| Term | First use (chapter) | Form | Translation strategy |
|------|---------------------|------|----------------------|
| *sinaniban* | Ch 13 | Voice note | Italicized first use; not glossed |
| *multo* | Ch 9 | Queue annotation | Italicized first use; glossed via context |
| *engkanto* | Ch 13 | Voice note | Italicized first use; not glossed |
| *anito* | Ch 18 | Letter to Joy | Italicized first use; brief context |
| *aswang* | Ch 18 | Letter to Joy | Italicized first use; brief context |

---

## Tracking conventions

As chapters are drafted:
1. Add new motifs / refinements here
2. Update first-appearance and recurrence columns
3. Note in [THEME_DOSSIERS.md](THEME_DOSSIERS.md) which motifs each chapter is responsible for
4. Cross-check at revision time that motifs are landing as planned

---

*This tracker is a living document. Initial listing only; will expand significantly as outline and drafting progress.*
